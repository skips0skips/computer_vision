...
class VisualOdometry():
    ...
    def _load_calib(filepath):
        """                                    
        Загружает калибровку камеры
        Параметры:
        filepath - путь к файлу (str): путь к файлу камеры
        K_l (ndarray): Внутренние параметры для левой камеры. Размерность (3,3)
        P_l (ndarray): Проекционная матрица для левой камеры. Размерность (3,4)
        K_r (ndarray): Внутренние параметры для правой камеры. Размерность (3,3)
        P_r (ndarray): Проекционная матрица для правой камеры. Размерность (3,4)
        """
